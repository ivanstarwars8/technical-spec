  ...
  return (
    <div className="space-y-6">
      <form onSubmit={handleSubmit} className="card space-y-4">
        <h2 className="text-xl font-bold">Сгенерировать домашнее задание</h2>
        ...
        <div className="card">
          ...
          <div className="space-y-4">
            {result.generated_tasks.tasks.map((task) => (
              <div key={task.number} className="border-l-4 border-primary-500 pl-4 py-2">
                <div className="font-semibold mb-2">Задача {task.number}</div>
                <div className="mb-2">{task.text}</div>
                <details className="text-sm text-gray-600">
                  <summary className="cursor-pointer font-medium">Решение</summary>
